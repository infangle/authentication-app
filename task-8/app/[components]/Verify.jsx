...
const Verify = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 px-6 gap-8">
      <h1 className="font-poppins text-4xl font-black leading-10 text-center text-[#25324B]">
        Verify Email
      </h1>
      <p className="font-epilogue text-base font-normal leading-7 text-center text-[#515B6F]">
      We've sent a verification code to the email address you provided. To complete the verification process, please enter the code here.      </p>
